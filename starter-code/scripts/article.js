...
Article.prototype.toHtml = function() {
  ...
  We need to fill in:
    ...
    4. article body, and
    5. publication date. */
  $('category h1').text(this.title);
  $('category a').text(this.author);
  $('category a').href(this.authorUrl);
  $('category time').text(this.publishedOn);
  $('category section').text(this.body);
